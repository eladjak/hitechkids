            ...
            <div className="px-4 py-4 flex flex-col gap-2">
              {navLinks.map((link) => (
                <a
                  ...
                  className={`px-4 py-3 rounded-lg font-medium text-center transition-colors ${
                    link.href === "#register"
                      ? "bg-gradient-to-r from-[#ff1493] to-[#ffe600] text-white font-bold"
                      : "text-white/80 hover:text-[#00d4ff] hover:bg-white/10"
                  }`}
                >
                  {link.label}
                </a>
